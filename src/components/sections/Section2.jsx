  ...
  return (
    <section id="about" className="min-h-[70vh]">
      ...
      <div className="mb-12 flex flex-col gap-2">
        <p className="text-center text-xl font-semibold">Tentang Saya</p>
      ...
      <div className="flex justify-center">
        <div className="flex w-1/2 flex-col items-center justify-center text-center">
          ...
          <p className="italic">
            Hello semuanya, Aku Fadly, seorang yang berdedikasi untuk menciptakan solusi digital yang inovatif.
